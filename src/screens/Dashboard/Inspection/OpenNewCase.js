...
const OpenNewCase = ({ navigation }) => {
  ...
  const addData = async () => {
    try {
      ...
      showSucess("Data uploaded successfully");
    } catch (error) {
      console.error("Error adding case data to Firestore: ", error);
      setLoading(false);
      // Handle error
    }
  };
    ...
    return (
      <View style={styles.headerStyle}>
        ...
        <View style={styles.cityTextStyle}>
          <Text style={styles.city}>New Case Details</Text>
        </View>
      </View>
    );
  }
